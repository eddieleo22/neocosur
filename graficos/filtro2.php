...
<div id="container">
 ...
 <?php include( 'lateral.php' ); ?>
  ...
  <div class="titulo_graficos">ESTADISTICAS RESUMEN NEOCOSUR  Morbilidad
...
<div id="espacio_portadas">
  <div id="wrapper">
  <form id="form1" name="F" method="get" action="graficos3.php">
              ...
              <td bgcolor="#eaeaea">
                  ...
                  <tr> 
                          ...
                          <td align="left" bgcolor="#eaeaea">
                                ...
                                <SELECT NAME="selCombo" SIZE=1 onChange="" class="campos">    
                  ...
                  <tr> 
                          <td align="right" bgcolor="#eaeaea"><strong>Condición</strong></td>
                    <td align="left" valign="top" bgcolor="#eaeaea">
                            
                            
                    <select name="opcCondicion" class="campos" id="opcCondicion">
                        <option value="0">Seleccione</option>
                        <OPTION VALUE="1">Muerte</OPTION>
                        <OPTION VALUE="2">HIC Grave (III y IV)</OPTION>
                        <OPTION VALUE="3">Leucomalacia</OPTION>
                        <OPTION VALUE="4">Oxígeno 36 semanas EC</OPTION>
                        <OPTION VALUE="5">DBP</OPTION>
                        <OPTION VALUE="6">Rup Alveolar</OPTION>
                        <OPTION VALUE="7">ECN</OPTION>
                        <OPTION VALUE="8">Retinopatía Global</OPTION>
                        <OPTION VALUE="9">Sepsis Precoz</OPTION>
                        <OPTION VALUE="10">Sepsis tardía</OPTION>
                        <OPTION VALUE="11">HIC Total</OPTION>
                  ...
                  <tr> 
                          <td align="right"  bgcolor="#eaeaea"><strong>Opci&oacute;n</strong></td>
			
                          <td align="left" valign="top" bgcolor="#eaeaea">
                                <select name="opcion_edad_peso" class="campos" id="hic_grado">
                                <option value="0">Seleccione</option>
                   ...
                   <tr>     
                   			<td align="right"  bgcolor="#eaeaea"><strong>Centro</strong></td> 
                            <td>   
                                <select name="idcentro" class="campos" id="idcentro">

                                    <?php

										if (User::getCurrent()->hasRole(ConstantRoles::$Colaborador)) {
											$Centros = Centros::activeCenters(User::getCurrent()->getCentro()->IDE_CNT);
										} else {
											$Centros = Centros::activeCenters();
										}
										foreach($Centros as $centro)
										{

                                            echo "<option value=\"".$centro->IDE_CNT."\">".$centro->NOM_CNT."</option>";
                                        }
                                    ?> 
