...
<div id="container">
 ...
 <?php include( 'lateral.php' ); ?>
  ...
  <div class="titulo_graficos">
      ESTADISTICAS DETALLE NEOCOSUR de Mortalidad 
...
<div id="espacio_portadas">
  ...
  <form id="form1" name="F" method="post" action="mortalidad_graf.php" >
              ...
              <td bgcolor="#eaeaea">
                  ...
                  <tr> 
                          ...
                          <td align="left" bgcolor="#eaeaea">
                                ...
                                <SELECT NAME="opcion_ano" SIZE=1 onChange="" class="campos">    
                  ...
                  <tr> 
                    ...
                    <select name="opctrimestre" class="campos" id="opctrimestre">
