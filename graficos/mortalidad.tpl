...
<html>
    <head>
        ...
        <script type="text/javascript" src="mortalidad.js" charset="utf-8"></script>
        <style type="text/css">
            #wraper { 
                width: 920px;
                margin: 0 auto;
            ...
            .center .x-panel-header-text-container{
                text-align: center}
            .x-grid-cell-tramo .x-grid-cell-inner {
                background-color: #d5e6f7;
                color: #023ca9;
                font-weight: bold;
            }
            .x-grid-cell-tramo_total .x-grid-cell-inner {
                background-color: #d5e6f7;
                color: #023ca9;
                font-weight: bold;
            }
    ...
    <body id="docbody">
        <div id="wraper">
            ...
            <div style="width: 452px; float: left;">
                ...
                <div style="float: left; width: 452px; height: 14px;"></div>   
                <div id="grid" style="float: left; width: 452px;"></div>   
            </div>
            <div style="width:14px; height: 100%; float:left">&nbsp;</div>
            <div style="width: 452px; float: left;">
                <div id="wrap_total" style="float: left; width: 452px; "></div>
                <div style="float: left; width: 452px; height: 14px;"></div>   
                <div id="grid_total" style="float: left; width: 452px;"></div>   
            </div>
            <div style="float: left; background-image: url( gracf.png); width: 452px; height: 414px" ></div>
        </div>
    </body>
</html>
