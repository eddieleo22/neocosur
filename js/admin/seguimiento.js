...
//MIGRACION
 ...
 if($("#migracion_padre_si").prop("checked"))
        {
		
            $("#padre_si").show();
        }

 if($("#migracion_madre_si").prop("checked"))
        {
 ...
 $("#migracion_madre_si").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
	 ...
	 $("#migracion_madre_no").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
			
            $("#madre_si").hide();
			$("input[name*='migracion_desde_madre']").val("");
        }
...
$("#migracion_padre_si").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
	 ...
	 $("#migracion_padre_no").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
			
            $("#padre_si").hide();
			$("input[name*='migracion_desde_padre']").val("");
        }
		
    });

//OXIGENO SUSPENSION
if($("#o2_si").prop("checked"))
        {
		
            $("#div_fecha_oxigeno").show();
        }
		
  

$("#o2_si").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
	 ...
	 $("#o2_no").change(function(){ 
        var $input = $(this);
        if($input.prop("checked"))
        {
			
            $("#div_fecha_oxigeno").hide();
			$("input[name*='fecha_suspension_ox']").val("");
        }
		
    });

	
	// Cirugia ojos INBGRESO
// -------------------------------------------
