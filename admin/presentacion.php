...
include ("../../neocosur_contenido/rules.php");
 ...
 if(isset($_GET["tipo_archivo"]))$tipo = '32';
...
//-------Listar por un tema especifico-------//
 ...
 $autor_tema= $funcionBusqueda->BuscaAutortema($conn, $tema);
  ...
  if (isset($_SESSION['id_usuario'])) {
	  ...
	  $sql = $funcionBusqueda->ListarArchivosAgno($conn, $tema, $perfil, $usuario, $tipo, $agno);	  
      $sql_com = $funcionBusqueda->ComentariosTema($conn, $tema, $perfil, $usuario);
	  	    	 
  }else{ //usuario publico
     $sql = $funcionBusqueda->ListarArchivosAgno($conn, $tema, "0", $usuario, $tipo, $agno);
   ...
   ?>
      <div class="row noticia">
        <div class="col-lg-8">
          ...
          <p><?php echo $texto; ?></p>
          <button type="button" class="btn btn-default"><a href="../../neocosur_contenido/bajando.php?archivo=<?php echo $archivo["nom_archivo"];?>" target="_blank">Descargar</a></button> 
