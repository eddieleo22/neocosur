  ...
  <form action="Negocio/usuarioBO.php" method="post" name="centro" onSubmit="return validarPasswd()" >
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="text" name="nombres" class="form-control input-sm" contenteditable="false" required >
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="text" name="paterno" class="form-control input-sm" contenteditable="false"  required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="text" name="materno" class="form-control input-sm" contenteditable="false" >
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="text" name="usuario" class="form-control input-sm" contenteditable="false" disabled>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="password" name="pass" id ="pass1" minlength="8" class="form-control input-sm" contenteditable="false" >
      ...
      <div class="form-group">
        ...
        <div class="col-lg-7">
          <input type="password" name="pass2" id ="pass2" minlength="8" class="form-control input-sm" contenteditable="false" >
		  <span id="campoOK"></span>
        </div>
      </div>
