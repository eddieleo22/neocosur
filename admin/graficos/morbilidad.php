...
<div class="loader"></div>
        <script>
				...
				//
                var ajax_url = "graficos/datos/morbilidadDatos.php";                
                    ...
                    if (ajax_request.readyState == 4 ) {
                        ...
                        if(response.success){
                            ...
                            for ( et in response.data.etiqueta ) {
                                ...
                                etiquetasGrafico[et] = response.data.etiquetaGrafico[et];          
						...
						console.log("etiquetas-> uno > "+etiquetasGrafico.length );
						console.log("id3> "+id3 );
								...
								window.myBar.data = 
								{
										...
										datasets: [{
											label: 'Presenta Patología (P)',
											backgroundColor: '#eaeaea',
											data: datas0                 
										}, {
											label: 'No Presenta Patología (N/P)',
                    ...
                    if (ajax_request.readyState == 4 ) {
                        ...
                        if(response.success){
                            ...
                            for ( et in response.data.etiquetaT ) {
                                ...
                                etiquetasGraficoT[et] = response.data.etiquetaGraficoT[et];          
								console.log("etoais "+ etiquetasT[et]);	
                            }
						...
						console.log("etiquetas-> uno > "+etiquetasGraficoT.length );
						console.log("id3> "+id3 );
							
								window.myBar2.data = {
								labels: etiquetasGraficoT,
										datasets: [{
											label: 'Presenta Patología (P)',
											backgroundColor: '#eaeaea',
											data: datas0T                 
    ...
    function construirCanvas(id, grafico){
			...
			var selection3 = 0;//document.getElementById("opcGraficos3").value;
		...
		//div = document.getElementById("panel-body");
		...
		for(var h = 0; h < 1; h++) {
			...
			console.log("cantidad en tabla11  "+count);
		...
		for(var h = 0; h < 1; h++) {
			...
			//console.log("");
			var count = Object.keys(datosTabla).length-1;
        ...
        mytable.setAttribute("border","1");
		mytable.setAttribute("name","derecha");
		var tabla = document.getElementsByTagName("derecha");		
